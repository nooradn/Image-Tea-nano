...
class StatsSectionWidget(QWidget):
    def __init__(self, parent=None):
        ...
        file_total_widget, self.label_total = make_icon_label("fa5s.images", "Total Images: 0")
        file_selected_widget, self.label_selected = make_icon_label("fa5s.check-square", "Selected: 0")
        file_failed_widget, self.label_failed = make_icon_label("fa5s.times-circle", "Failed: 0")
        file_success_widget, self.label_success = make_icon_label("fa5s.check-circle", "Success: 0")
        file_draft_widget, self.label_draft = make_icon_label("fa5s.edit", "Draft: 0")
        ...
        gen_time_widget, self.label_gen_time = make_icon_label("fa5s.clock", "Generation Time: 0 ms")
        avg_time_widget, self.label_avg_time = make_icon_label("fa5s.stopwatch", "Average Time: 0 ms")
        longest_time_widget, self.label_longest_time = make_icon_label("fa5s.hourglass-end", "Longest Time: 0 ms")
        last_time_widget, self.label_last_time = make_icon_label("fa5s.history", "Last Time: 0 ms")
        total_time_widget, self.label_total_time = make_icon_label("fa5s.calendar-check", "Total Time: 0 ms")
        ...
        token_input_widget, self.label_token_input = make_icon_label("fa5s.sign-in-alt", "Token Input: 0")
        token_output_widget, self.label_token_output = make_icon_label("fa5s.sign-out-alt", "Token Output: 0")
        token_total_widget, self.label_token_total = make_icon_label("fa5s.coins", "Token Total: 0")
